...
| size           | [Input.types.size.SMALL,Input.types.size.MEDIUM,Input.types.size.LARGE]                                                                                                                                     | false    | types.MEDIUM               | Changes the size of the input.                                                                      |
| type           | [types.inputValidTypes.EMAIL,types.inputValidTypes.NUMBER,types.inputValidTypes.PASSWORD,types.inputValidTypes.SEARCH,types.inputValidTypes.TELEPHONE,types.inputValidTypes.TEXT,types.inputValidTypes.URL] | false    | types.inputValidTypes.TEXT | Allows user to specify the type of input.                                                           |
