...
| size           | [ Input.types.size.SMALL, Input.types.size.MEDIUM, Input.types.size.LARGE]                                                                             | false    | Input.types.size.MEDIUM | Changes the size of the input, and error message font size. Size SMALL is deprecated in design guideline                                                                                                                                 |
