...
| size               | ShirtSizes.DEFAULT  | false    | ShirtSizes.MEDIUM | Changes the size of the input.                                                                      |
| type               | InputValidTypes.ALL | false    | "text"            | Allows user to specify the type of input.                                                           |
