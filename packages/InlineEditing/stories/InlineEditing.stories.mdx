...
The InlineEditing package also offers a Table component which compose the [Table](https://github.com/acl-services/paprika/tree/master/packages/Table) component to provide
