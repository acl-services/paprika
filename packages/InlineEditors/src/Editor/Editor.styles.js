...
export const Value = styled(RawButton)(({ status }) => css`
    &:hover,
    &:focus {
...
export const OptimisticValue = styled.div(() => css`
    align-items: center;
    box-sizing: border-box;
...
export const Success = styled.div(() => css`
...
export const Error = styled.div(() => css`
    ${icon};
...
export const Idle = styled.div(() => css`
    ${icon};
    opacity: 0;
  `);
