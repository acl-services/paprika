...
| borderType                    | [types.GRID,types.NONE,types.HORIZONTAL,types.VERTICAL] | false    | types.GRID | Define the look for borders in the table types.DataGrid.GRID, types.DataGrid.NONE, etc.      |
| children                      | node                                                    | true     | -          |                                                                                              |
