...
const isOneOf = (rowValue, multiSelectSelectedValues) => multiSelectSelectedValues.length === 0 || multiSelectSelectedValues.includes(rowValue);

const isNotOneOf = (rowValue, multiSelectSelectedValues) => multiSelectSelectedValues.length === 0 || !multiSelectSelectedValues.includes(rowValue);
