...
| length      | custom | false    | "medium" | Length of the pagination (the number of other pages will be displayed around active page). |
| onClickPage | func   | true     | -        | Callback to be executed when current page is changed.                                      |
