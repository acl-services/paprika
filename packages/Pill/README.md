...
| pillColor  | [[types.BLACK, types.BLUE, types.GREEN, types.GREY, types.ORANGE, types.LIGHT_BLUE, types.LIGHT_ORANGE],types.severityPillColors] | false    | types.GREY   |             |
| size       | [types.SMALL,types.MEDIUM]                                                                                                        | false    | types.MEDIUM |             |
