...
| ------------ | ----------------------------------------------- | -------- | -------- | -------------------------------------------------------------------------------------------------------------------- |
| color        | [object Object],[object Object],[object Object] | false    | "grey"   | Background color of the counter.                                                                                     |
...
| size         | ShirtSizes.LIMITED                              | false    | "medium" | Size of counter. It can be small or medium. Default is medium.                                                       |
