...
| ------------ | --------------------------------- | -------- | ------------ | -------------------------------------------------------------------------------------------------------------------- |
| color        | [types.GREY,types.BLUE,types.RED] | false    | types.GREY   | Background color of the counter.                                                                                     |
...
| size         | [types.SMALL,types.MEDIUM]        | false    | types.MEDIUM | Size of counter. It can be small or medium. Default is medium.                                                       |
