...
export default function OptionsSelected() {
    ...
    return (
      <>
        <div css={title}>
          ...
          <span css={counter} data-pka-anchor="list-box-browser-optionselected-counter">
            0
          </span>
        </div>
  ...
  return (
    <>
      ...
      <div css={container}>
        {Object.keys(selectedOptions).map(key => selectedOptions[key].map(option => {
            ...
            return (
              <div key={option.$$key} css={optionStyles} data-pka-anchor="list-box-browser-selected-option">
                <RawButton css={button} onClick={handleClick(option)}>
                  <div css={optionLabel} data-pka-anchor="list-box-browser-selected-option-label">
                    {option.attributes.label}
                  </div>
                  <div css={optionBreadcrumb}>
                    {breadcrumb.map((option, index, list) => (
                      <span key={option.$$key} data-pka-anchor="list-box-browser-selected-option-breadcrumb">
                ...
                <RawButton
                  ...
                  data-pka-anchor="list-box-browser-selected-option-trashbin"
                >
                  <Trashbin />
                </RawButton>
              </div>
