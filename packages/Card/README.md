...
| size        | [Card.types.size.AUTO,Card.types.size.SMALL,Card.types.size.MEDIUM,Card.types.size.LARGE] | false    | types.AUTO | Size of the card (font size, min-height, padding, etc).            |
