...
export const CloseButtonStyled = styled(Button.Close)`
  ...
  ${closeButtonColors[props.kind] && `color: ${closeButtonColors[props.kind]};`}
  `}
`;

export const IconWrapper = styled.div`
  ${props => `
  color: ${iconColors[props.kind]};
  flex-grow: 0;
  flex-shrink: 0;
...
export const ToastWrapper = styled.div`
  ${props => `
    ...
    ${stylers.fontSize()}
    ${stylers.lineHeight()}
    ${props.isFixed && fixedStyles};
    ${props.kind === Kinds.VISUALLY_HIDDEN && visuallyHidden};
  `}
`;
