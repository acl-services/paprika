...
| size                  | [FormElement.types.size.SMALL,FormElement.types.size.MEDIUM,FormElement.types.size.LARGE] | false    | types.MEDIUM | Size of the label, error, help and description (font size, min-height, padding, etc).                      |
