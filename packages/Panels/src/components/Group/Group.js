...
export default function Group(props) {
  ...
  const { Panels: sidePanels, "Panels.Overlay": OverlayExtracted } = extractChildren(children, [
    "Panels",
    "Panels.Overlay",
  ]);
  if (!Array.isArray(sidePanels)) {
    throw new Error("<Panels.Group /> is intented to be use with two or more Panelss");
  }
  ...
  return ReactDOM.createPortal(
    <React.Fragment>
      {OverlayExtracted}
      <sc.Group {...moreProps} offsetY={offsetScroll} data-pka-anchor="panels.group">
