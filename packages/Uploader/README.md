...
# @paprika/uploader - 1.0.2-alpha.1
...
| supportedMimeTypes | arrayOf | false    | ["*/*"]           | An array of strings describing the allowed file types for the uploader. Common types can be found here: https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types/Common_types. Use the "MIME Type" -- not the "Extension" -- value. |
