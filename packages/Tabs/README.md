...
| defaultIndex       | number                                                | false    | 0                       | Sets what tabindex is active by default (uncontrolled component). -1 for no active tab.                                                                                             |
...
| index              | number                                                | false    | null                    | Sets what tabindex is active (controlled component). -1 for no active tab.                                                                                                          |
