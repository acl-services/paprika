...
| ----------------- | ------ | -------- | ------- | --------------------------------------------- |
| children          | node   | false    | null    | Used for CopyInput.Input and CopyInput.Button |
| isReadOnly        | bool   | false    | true    | Is the input read-only.                       |
| value             | string | false    | ""      | Default value for the input                   |
| hasValueShown     | bool   | false    | true    | Should hide the value text                    |
| hasInputContainer | bool   | false    | true    | Is the input component used                   |
