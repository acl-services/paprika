...
| size        | [ButtonGroup.types.size.SMALL,ButtonGroup.types.size.MEDIUM,ButtonGroup.types.size.LARGE] | false    | types.MEDIUM | Size of the buttons (height, font size, etc).                                                                                                        |
