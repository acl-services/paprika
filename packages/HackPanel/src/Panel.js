...
const PUSH_REF_TRANSITION_STYLE = "left-right 0.2s ease";
...
export default function Panel(props) {
  ...
  React.useLayoutEffect(() => {
    ...
    if (isOpen) {
      pushContentRefStyle.marginLeft = width;
    } else {
      pushContentRefStyle.transitionDelay = "0s";
      pushContentRefStyle.marginLeft = "0";
    }
...
const defaultProps = {
  ...
  onAfterOpen: () => {},
  onClose: null,
  slideFrom: types.slideFroms.LEFT,
  width: "33%",
  zIndex: zValue(7),
};
