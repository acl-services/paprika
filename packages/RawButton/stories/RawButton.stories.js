...
export const showcase = () => (
  <ExampleStory storyName="RawButton" tagline={ExampleStory.defaultTaglines.showcase}>
    <Showcase />
  </ExampleStory>
);
showcase.story = {
...
export const variations = () => (
  <ExampleStory storyName="RawButton" tagline={ExampleStory.defaultTaglines.variations}>
    <Variations />
  </ExampleStory>
);
variations.story = {
