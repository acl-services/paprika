...
declare function Table(props:TableProps): JSX.Element;
  interface TableProps{
    ...
    borderType?: Table.types.border.GRID|Table.types.border.NONE|Table.types.border.HORIZONTAL|Table.types.border.VERTICAL;
...
declare namespace Table{
  namespace types{
    namespace border{
      const GRID: any;const NONE: any;const HORIZONTAL: any;const VERTICAL
: any;
    }
  }
}
