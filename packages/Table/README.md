...
| --------------- | ------------------------------------------------------- | -------- | ---------- | --------------------------------------------------------------------------------- |
| borderType      | [types.GRID,types.NONE,types.HORIZONTAL,types.VERTICAL] | false    | types.GRID | Define the look for borders in the table Table.types.GRID, Table.types.NONE, etc. |
