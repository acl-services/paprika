...
| kind         | [Button.types.kind.DEFAULT,Button.types.kind.SECONDARY,Button.types.kind.DESTRUCTIVE,Button.types.kind.FLAT,Button.types.kind.MINOR,Button.types.kind.LINK] | false    | types.DEFAULT | The visual style of the button.                                                                                  |
