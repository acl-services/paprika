...
### DatePicker.ShortcutPanel

| Prop      | Type       | required | default | Description                                      |
| --------- | ---------- | -------- | ------- | ------------------------------------------------ |
| date      | instanceOf | true     | -       |                                                  |
| isVisible | bool       | true     | -       | If the ShortcutPanel is set to be visible        |
| onCancel  | func       | true     | -       | Function to call when cancel button is clicked.  |
| onConfirm | func       | true     | -       | Function to call when primary button is clicked. |
