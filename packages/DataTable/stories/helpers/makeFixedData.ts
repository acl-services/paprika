const allData = [
  {
    ...
    progress: 36,
    status: "relationship",
    desc: "Exercitationem autem doloribus. Iste laboriosam praesentium qui aliquid debitis. Ex tenetur cumque omnis sed quo natus. Voluptatem necessitatibus amet dolores nemo.",
  ...
  },
  {
    ...
    progress: 32,
    status: "relationship",
    desc: "Nam odit sint. Aut perferendis illo distinctio dolorem distinctio. Incidunt natus iusto ut totam sunt. Qui corrupti in reiciendis id. Et aut et sed ratione. Aut consequatur molestias.",
    desc_more:
  ...
  },
  {
    ...
    progress: 77,
    status: "single",
    desc: "Aut beatae quam vel quia sunt quo a dolorum. Dolorem quod velit necessitatibus. Rerum quasi quia velit non fugiat et est ut saepe. Alias ea quod dolore error ex rerum ut nisi. Excepturi magni porro rerum repellat quia quas. Aperiam incidunt mollitia tempora fugit.",
    desc_more:
  ...
  },
  {
    ...
    progress: 52,
    status: "relationship",
    desc: "At reprehenderit enim et nemo quia eaque voluptatem minima. Dolorem animi sed quibusdam nemo voluptatem porro nesciunt. Voluptas laboriosam dolor modi sit consequuntur deserunt cum. In ut animi magni sed eius ratione asperiores.",
    desc_more:
  ...
  },
  {
    ...
    progress: 13,
    status: "complicated",
    desc: "Aperiam rem explicabo excepturi cumque aut hic provident nemo labore. Totam incidunt eos sed. Beatae earum et aut. Laboriosam similique rem quod et labore assumenda non cupiditate saepe. Asperiores possimus iure. Temporibus libero dicta in quo est explicabo rerum excepturi eaque.",
    desc_more:
  ...
  },
  {
    ...
    progress: 64,
    status: "relationship",
    desc: "Voluptatum quia occaecati. Voluptas quis fugiat illum culpa. Deleniti quia voluptatem at quia quo. Quidem qui sed consequatur qui corrupti est.",
    desc_more:
  ...
  },
  {
    ...
    progress: 30,
    status: "complicated",
    desc: "Voluptates enim voluptate distinctio. Provident dolorem tenetur veniam numquam ipsa non est corporis deserunt. Voluptatem architecto impedit et numquam et.",
    desc_more:
  ...
  },
  {
    ...
    progress: 32,
    status: "single",
    desc: "Minima molestiae qui et impedit eveniet quasi. Iusto aperiam saepe. Deleniti dolores ut dolores consectetur numquam possimus eos minima et.",
    desc_more:
  ...
  },
  {
    ...
    progress: 42,
    status: "complicated",
    desc: "Aut autem quo cum rerum illum nulla. Maiores nisi numquam. Nobis commodi adipisci eligendi reprehenderit. Et sapiente aut quia qui ea ut sit. Facilis debitis sapiente.",
    desc_more:
  ...
  },
  {
    ...
    progress: 91,
    status: "single",
    desc: "Aut temporibus doloremque quo omnis. Dolore repellat assumenda laborum ut quam adipisci. Harum nihil rerum quia quod amet eaque neque dolorum odio.",
    desc_more:
  ...
  },
  {
    ...
    progress: 48,
    status: "relationship",
    desc: "Voluptas fugit quo et ratione accusantium non. Nesciunt est mollitia quaerat laborum. Ea earum et qui sequi quo eaque dolorem. Unde velit sit voluptatem laboriosam. Dolor cum soluta consequatur et voluptates sit et aut itaque.",
    desc_more:
  ...
  },
  {
    ...
    progress: 88,
    status: "complicated",
    desc: "Adipisci eveniet rerum deleniti consequuntur totam et id in enim. Velit et suscipit ut. Sint vel sed eos assumenda velit. Quis quibusdam dolorem reprehenderit sit. Ex minima quidem omnis. At occaecati eveniet odio iure quidem et.",
    desc_more:
  ...
  },
  {
    ...
    progress: 36,
    status: "relationship",
    desc: "Iure suscipit voluptatem tempore rerum. Ab id aut reiciendis consequatur provident sunt ullam quia. Perspiciatis eum aliquid eius natus qui est.",
    desc_more:
  ...
  },
  {
    ...
    progress: 26,
    status: "complicated",
    desc: "Exercitationem illo atque dolores consectetur perferendis quo deserunt nulla impedit. Molestiae commodi suscipit ea fugit quas nihil et. Perspiciatis quia non ipsa rerum doloribus vel soluta rerum non. Non aut expedita asperiores vero quae.",
    desc_more:
  ...
  },
  {
    ...
    progress: 48,
    status: "complicated",
    desc: "Nam quae labore sed fugit iste. Perferendis sed quisquam laboriosam non inventore enim. Impedit voluptatibus animi. Voluptatibus rerum qui modi.",
  ...
  },
  {
    ...
    progress: 1,
    status: "relationship",
    desc: "Laborum dicta aspernatur. Laboriosam non sequi quis esse voluptatem fuga velit et quae. Cumque distinctio omnis earum quos ad tenetur magni enim.",
    desc_more:
  ...
  },
  {
    ...
    progress: 37,
    status: "relationship",
    desc: "Dolores eum repellendus magnam non id. Ea et animi ipsam. Temporibus rerum culpa aspernatur ea aut qui non. Corrupti architecto ut saepe perferendis esse.",
    desc_more:
  ...
  },
  {
    ...
    progress: 41,
    status: "single",
    desc: "Et laudantium praesentium quaerat vel quasi. Eum provident voluptate et quo qui. Laudantium quod et modi optio blanditiis qui quam non eos. Voluptatem quia quaerat qui nisi blanditiis itaque deserunt impedit.",
    desc_more:
  ...
  },
  {
    ...
    progress: 91,
    status: "relationship",
    desc: "Iusto molestiae alias distinctio laudantium facilis iure fugiat culpa. Assumenda distinctio repellat qui. Omnis iusto autem doloremque. Perspiciatis et reiciendis nam delectus tenetur eum.",
    desc_more:
  ...
  },
  {
    ...
    progress: 56,
    status: "relationship",
    desc: "Sed deserunt dolor sapiente dolor amet vitae illo molestiae voluptates. Doloribus tempora minima. A nobis quod illum consequatur. Ea eum aspernatur ut distinctio ut voluptas repellendus aperiam.",
    desc_more:
  ...
  },
  {
    ...
    progress: 81,
    status: "complicated",
    desc: "Repellat error fugiat eligendi deleniti quasi ea velit in voluptas. Et adipisci enim iusto. Animi ullam temporibus sed et aspernatur inventore.",
    desc_more:
  ...
  },
  {
    ...
    progress: 63,
    status: "single",
    desc: "Delectus incidunt quaerat. Omnis exercitationem labore aut. Ullam atque dolores. Ipsa ratione eligendi odio. At sint quis exercitationem neque eos molestiae veritatis rerum consequatur.",
    desc_more:
  ...
  },
  {
    ...
    progress: 32,
    status: "relationship",
    desc: "Ullam nam corrupti sunt et dolor aliquid. Nostrum unde ipsum consequuntur expedita aut nobis. Saepe aut perspiciatis itaque quibusdam molestias at in. Deserunt sed quia veniam consequatur cumque perspiciatis est.",
    desc_more:
  ...
  },
  {
    ...
    progress: 63,
    status: "complicated",
    desc: "Dolores tempora ratione doloribus et necessitatibus corporis. Et ratione voluptas id nisi ut aperiam. Laboriosam tenetur minima sit minus sit dolor. Corrupti velit quos suscipit nihil quia qui pariatur molestiae sed.",
    desc_more:
  ...
  },
  {
    ...
    progress: 46,
    status: "complicated",
    desc: "Eius libero sed velit. Quasi enim sequi ipsum et assumenda occaecati. Occaecati magnam quam rem et. Aspernatur corporis quaerat eos.",
    desc_more:
  ...
  },
  {
    ...
    progress: 43,
    status: "complicated",
    desc: "Praesentium repudiandae dolorem deserunt excepturi laborum vitae. Vero mollitia nemo ipsum cumque modi iure. Necessitatibus sapiente autem et deleniti repellendus earum culpa dolor sed.",
    desc_more:
  ...
  },
  {
    ...
    progress: 79,
    status: "relationship",
    desc: "Fugit rerum consectetur. Optio dicta perferendis ipsa qui voluptatem quas. Dolores quia accusantium est facere omnis et ratione.",
    desc_more:
  ...
  },
  {
    ...
    progress: 10,
    status: "single",
    desc: "Enim eos sed nesciunt esse beatae soluta esse quo omnis. Quia et est. Et vero veritatis voluptas voluptatum quae. Et sit labore. Aut dolore perspiciatis aperiam nisi sapiente. Qui aliquam rerum voluptates iusto.",
    desc_more:
  ...
  },
  {
    ...
    progress: 98,
    status: "single",
    desc: "Veritatis aut est praesentium reprehenderit nesciunt consequatur molestiae voluptatem delectus. Aliquam non et consequuntur vel perspiciatis voluptas dolore nihil ducimus. Cupiditate perferendis reprehenderit beatae animi consequuntur tenetur. Libero dicta laudantium ut molestias repudiandae consequatur sunt et nesciunt. In dignissimos impedit officia voluptatibus quidem et odit.",
    desc_more:
  ...
  },
  {
    ...
    progress: 75,
    status: "complicated",
    desc: "Eligendi et perferendis. Culpa atque voluptate voluptatem dicta illum numquam. Sint quis ut est quia. Numquam velit sed ut. Rerum vitae est. Aut cumque ex quae nulla eum consequatur.",
    desc_more:
  ...
  },
  {
    ...
    progress: 21,
    status: "relationship",
    desc: "Quaerat quia deserunt quia. Quia aut sed quo nihil quo totam esse. Voluptatem harum quo ducimus quibusdam enim mollitia est et. Qui repellat dolorem nihil repellendus nisi earum dolorem blanditiis dolorem. Quis qui quidem ullam est consequatur.",
    desc_more:
  ...
  },
  {
    ...
    progress: 66,
    status: "complicated",
    desc: "Et animi commodi sunt aut assumenda unde numquam. Ab ut in qui. Aut quia molestias nostrum nisi autem dolor omnis voluptatem blanditiis.",
    desc_more:
  ...
  },
  {
    ...
    progress: 5,
    status: "relationship",
    desc: "Nulla deserunt dolores distinctio veritatis laboriosam. Quos et modi. Magni ullam dignissimos quo ipsam facilis.",
  ...
  },
  {
    ...
    progress: 39,
    status: "relationship",
    desc: "Voluptatem odio harum nihil. Omnis maxime omnis maxime tempore totam labore deserunt. Est esse aut magnam eveniet id aliquid explicabo. Voluptates delectus nulla pariatur fugiat.",
    desc_more:
  ...
  },
  {
    ...
    progress: 52,
    status: "complicated",
    desc: "Qui dolores aliquid sed corporis ut vitae id. Molestiae corrupti eos odio et omnis doloribus exercitationem asperiores. Omnis repellat incidunt error omnis. Accusamus et dolor magni aut quod ipsa ea in hic. Culpa voluptas error nihil in inventore. A molestiae est vitae eum voluptatem est adipisci.",
    desc_more:
  ...
  },
  {
    ...
    progress: 5,
    status: "relationship",
    desc: "Quod et et voluptates temporibus vero numquam et enim officiis. Molestias expedita necessitatibus eos eos nihil esse veritatis et. Dolorem et soluta dolor cum repellendus exercitationem ut voluptas. Placeat sed molestiae reprehenderit exercitationem ut voluptatem fugiat et. Nulla debitis illo perferendis at esse id harum modi.",
    desc_more:
  ...
  },
  {
    ...
    progress: 71,
    status: "relationship",
    desc: "Minus et adipisci possimus facilis sapiente blanditiis voluptatem. Ullam est sint quae. Dolores labore harum animi quo enim voluptate voluptatem dolores et. Quasi et est et. Voluptatem quae quaerat. Itaque esse quo.",
  ...
  },
  {
    ...
    progress: 53,
    status: "relationship",
    desc: "Dolore adipisci excepturi distinctio nulla iure quod minima non. Officiis voluptatem itaque vel vitae voluptatem similique quia et. Omnis et vero in molestiae sit reprehenderit rerum neque. Repellat consequatur repellat iusto vel fugiat. Ad expedita sit. Optio autem animi quos ut autem.",
    desc_more:
  ...
  },
  {
    ...
    progress: 37,
    status: "single",
    desc: "Et vel dicta earum quibusdam. Expedita sint dolorem. Quia non omnis quae sit atque assumenda et blanditiis aut. Cumque sit quis in exercitationem.",
    desc_more:
  ...
  },
  {
    ...
    progress: 48,
    status: "complicated",
    desc: "Quia animi eveniet veniam distinctio eveniet. Eos quia animi aspernatur. Sed commodi quidem perferendis eveniet fugiat temporibus ipsum qui molestiae. Aut rerum enim. Sed illo sint molestiae explicabo nulla beatae mollitia dolor.",
    desc_more:
