...
import CustomCheckers from "./stories/examples/customCheckers";
...
### Single select renderChecker prop
...
<Playground>
  ...
  <p>To remove the checkbox simply return a falsy value on the renderChecker method</p>
  <ListBox
    isMulti
    renderChecker={(isChecked, state, dispatch, index) => null}
    zIndex={10000}
