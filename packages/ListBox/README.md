...
# @paprika/list-box - 1.1.1-alpha.1
...
| renderTriggerPillLabel | func       | false    | null           | Provides an alternative for rendering the Pill label instead of using the default [{label:value}] coming from the og data |
