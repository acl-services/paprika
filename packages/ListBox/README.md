...
| hasVirtualization      | bool        | false    | false   | indicates if the option is under a virtualized component                               |
...
| Prop          | Type   | required | default | Description |
| ------------- | ------ | -------- | ------- | ----------- |
| height        | number | false    | 280     |             |
| itemCount     | number | true     | -       |             |
| itemSize      | number | false    | 32      |             |
| overscanCount | number | false    | 6       |             |
