...
| buttonType | [Trigger.types.button.ICON,Trigger.types.button.RAW,Trigger.types.button.SIMPLE] | false    | types.buttonTypes.SIMPLE | Determine the styling of the button |
